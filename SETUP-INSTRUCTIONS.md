...
1. **Go to your repository**: [https://github.com/scout-qualapps/test2](https://github.com/scout-qualapps/test2)
...
git clone https://github.com/scout-qualapps/test2.git
cd test2
